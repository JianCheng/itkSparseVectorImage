 ...
 *
 *=========================================================================*/
#ifndef __itkWarpSparseVectorImageFilter_h
#define __itkWarpSparseVectorImageFilter_h
...
namespace itk
{
/** \class WarpSparseVectorImageFilter
 * \brief Warps a sparse vector image using an input displacement field.
 *
 * WarpSparseVectorImageFilter warps an existing image of type
 * itk::SparseVectorImage with respect to a given displacement field.
 *
 ...
 * interpolation typed used is the SparseVectorImageLinearInterpolateImageFunction.
...
template<
  ...
  >
class ITK_EXPORT WarpSparseVectorImageFilter:
  public ImageToImageFilter< TInputImage, TOutputImage >
{
public:
  /** Standard class typedefs. */
  typedef WarpSparseVectorImageFilter                     Self;
  ...
  itkTypeMacro(WarpSparseVectorImageFilter, ImageToImageFilter);
  ...
  typedef SparseVectorImageInterpolateImageFunction< InputImageType, CoordRepType >
                                                                   InterpolatorType;
  typedef typename InterpolatorType::Pointer                       InterpolatorPointer;
  typedef SparseVectorImageLinearInterpolateImageFunction< InputImageType, CoordRepType >
  ...
  /** WarpSparseVectorImageFilter produces an image which is a different
...
protected:
  WarpSparseVectorImageFilter();
  // ~WarpSparseVectorImageFilter() {} default implementation is ok

  void PrintSelf(std::ostream & os, Indent indent) const;

  /** WarpSparseVectorImageFilter is implemented as a multi-threaded filter.
...
private:
  WarpSparseVectorImageFilter(const Self &); //purposely not implemented
...
#include "itkWarpSparseVectorImageFilter.hxx"
#endif
