 ...
 *
 *=========================================================================*/
#ifndef __itkResampleSparseVectorImageFilter_h
#define __itkResampleSparseVectorImageFilter_h
...
namespace itk
{
/** \class ResampleSparseVectorImageFilter
 * \brief Resample a sparse vector image via a coordinate transform
 *
 * ResampleSparseVectorImageFilter resamples an existing sparse vector image
 * through some coordinate transform, interpolating via some image function.
 ...
 * SparseVectorImageLinearInterpolateImageFunction<InputImageType,
 ...
 * SparseVectorImageNearestNeighborInterpolateImageFunction< InputImageType,
 ...
 * unit spacing, zero origin and identity direction.
 *
 ...
 * \wikiexample{ImageProcessing/ResampleSparseVectorImageFilter,Resample (stretch or compress) an image}
 * \endwiki
 */
template< class TInputImage,
          class TOutputImage,
          class TInterpolatorPrecisionType = double >
class ITK_EXPORT ResampleSparseVectorImageFilter:
  public ImageToImageFilter< TInputImage, TOutputImage >
{
public:
  /** Standard class typedefs. */
  typedef ResampleSparseVectorImageFilter                 Self;
  ...
  itkTypeMacro(ResampleSparseVectorImageFilter, ImageToImageFilter);
  ...
  typedef SparseVectorImageInterpolateImageFunction< InputImageType,
  ...
  typedef SparseVectorImageLinearInterpolateImageFunction< InputImageType,
                                                           TInterpolatorPrecisionType >
  ...
  /** ResampleSparseVectorImageFilter produces an image which is a different size
  ...
  /** ResampleSparseVectorImageFilter needs a different input requested region than
   * the output requested region.  As such, ResampleSparseVectorImageFilter needs
...
protected:
  ...
  /** ResampleSparseVectorImageFilter can be implemented as a multithreaded filter.
...
private:
  ResampleSparseVectorImageFilter(const Self &); //purposely not implemented
  ...
  std::vector<OutputImagePointer> m_IntermediateImages;
                                               // Store intermediate result
  std::vector<OutputImageRegionType> m_SplitRegions;

};
} // end namespace itk

#ifndef ITK_MANUAL_INSTANTIATION
#include "itkResampleSparseVectorImageFilter.hxx"
#endif
